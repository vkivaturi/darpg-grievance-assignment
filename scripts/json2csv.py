...
def main():
	...
	gievance_merged_file = open(gievance_merged_csv_file_name, 'w', encoding='utf8', newline='')

	# Create the csv writer object
	fieldnames = ['registration_no', 'org_code', 'dist_name', 'pincode', 'state', 'sex', 'history_id', 'history_officer_detail', 'history_org_code']
	csv_writer = csv.DictWriter(gievance_merged_file, fieldnames=fieldnames)
